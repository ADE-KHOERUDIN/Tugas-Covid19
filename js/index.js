...
function App() {
  ...
  r.useEffect(() => {
    loadCovidData()
      ...
      .catch(() => setErrorMessage('Mohon maaf tidak bisa mempatch data. Coba refresh halaman.'));
  }, []);
...
function TableFilters({
  ...
  return (
    e('form', {className: 'form-inline'},
      ...
      e('button', {className: 'btn btn-hijau mb-2', onClick: onReset},
